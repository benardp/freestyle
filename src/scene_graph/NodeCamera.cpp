...
:camera_type_(iBrother.camera_type_){
    std::memcpy(modelview_matrix_, iBrother.modelview_matrix_, 16*sizeof(double));
    std::memcpy(projection_matrix_, iBrother.projection_matrix_, 16*sizeof(double));
}
...
void NodeCamera::setModelViewMatrix(double modelview_matrix[16]){
    std::memcpy(modelview_matrix_, modelview_matrix,16*sizeof(double));
}

void NodeCamera::setProjectionMatrix(double projection_matrix[16]){
    std::memcpy(projection_matrix_, projection_matrix,16*sizeof(double));
}
