...
void AppOptionsWindow::Propagate() {
  ...
  // Directories
  ViewMapIO::Options::setModelsPath((const char*)modelsPathLineEdit->text().toStdString().data());
  PythonInterpreter::Options::setPythonPath((const char*)pythonPathLineEdit->text().toStdString().data());
  TextureManager::Options::setPatternsPath((const char*)patternsPathLineEdit->text().toStdString().data());
  TextureManager::Options::setBrushesPath((const char*)brushesPathLineEdit->text().toStdString().data());
